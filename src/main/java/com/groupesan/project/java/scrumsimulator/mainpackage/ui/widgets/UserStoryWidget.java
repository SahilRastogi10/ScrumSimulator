...
public class UserStoryWidget extends JPanel implements BaseComponent {
    ...
    private UserStoryListPane parentPanel;
    ActionListener actionListener = e -> {};

    public UserStoryWidget(UserStory userStory, UserStoryListPane parentPanel) {
    ...
    public void init() {
        ...
        MouseAdapter openEditDialog = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                EditUserStoryForm form = new EditUserStoryForm(userStory, parentPanel);
